<?php $site_url = $this->Url->build('/',true); ?>
    ...
    background:url(<?=$site_url?>images/bg2.jpg) no-repeat center;
	background-size:cover;">
            <div class="dtable hw100">
                <div class="dtable-cell hw100">
                    <div class="container text-center">
                        <h1 class="intro-title animated fadeInDown">Advertise on Realhome</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main-container inner-page">
        <div class="container">
            <div class="row clearfix">
                <h1 class="text-center title-1">Advertise on Realhome</h1>
